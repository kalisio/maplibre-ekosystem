...
export default withMermaid(
  defineConfig({
    base: '/maplibre-ekosystem/',
    title: 'maplibre-ekosystem',
    description: 'A collection of modules for Maplibre GL JS',
    ...
    themeConfig: {
      ...
      socialLinks: [{ icon: 'github', link: 'https://github.com/kalisio/maplibre-ekosystem' }],
      nav: [
